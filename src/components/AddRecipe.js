...
class AddRecipe extends React.Component {
    ...
    _onIngredientAdd(e) {
        this.setState({
            ingredientInput: '',
            ingredients: [...this.state.ingredients, { title: this.state.ingredientInput }]
        });
    }
    ...
    _onInstructionAdd(e) {
        this.setState({
            instructionInput: '',
            instructions: [...this.state.instructions, { title: this.state.instructionInput }]
        });
    }
